...
function clickButton() {
  const changeColor = (document.querySelector("body").style.backgroundColor =
    generateRandomColor());
  let quotes = randomQuote();
  let newQute = (document.querySelector(".quote").textContent = quotes.quote);
  let newSource = (document.querySelector(".source").textContent =
    quotes.source);
  if (quotes.citation !== undefined) {
    document.querySelector(".citation").textContent = quotes.citation;
  } else {
    document.querySelector(".citation").textContent = " ";
  }
  if (quotes.year !== undefined) {
    document.querySelector(".year").textContent = quotes.year;
  } else {
    document.querySelector(".year").textContent = " ";
  }
}
const loadQuote = document
  .querySelector("#loadQuote")
